...
class HRVREP_API UViveXRHeadsetSensorManager : public UObject, public ISensorManager 
{
	GENERATED_BODY()
public:
	// Initialise a sensor
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Init"))
	virtual void InitSensor(const FString& InName, float InRate) override;

	// Set the name of the sensor
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Set Name"))
	virtual void SetSensorName(const FString& InName) override;

	// Get the name of the sensor
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Get Name"))
	virtual const FString& GetSensorName() const override;

	// Set the sampling rate of the sensor
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Set Sampling Rate"))
	virtual void SetSensorSamplingRate(float InRate) override;

	// Get the sampling rate of the sensor
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Get Sampling Rate"))
	virtual float GetSensorSamplingRate() const override;

	// Update the sensor readings, to be called in ticks
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Update"))
	virtual void UpdateReadings() override;

	// Retreive the readings as a TMap using varibale names as keys
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Retrieve Readings"))
	virtual const TMap<FString, double>& RetrieveReadings() const override;

	// Retrive the variable names as array
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Retrieve Var Name"))
	virtual TArray<FString> RetrieveVarNames() const override;

	// Retrieve the values as array
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Retrieve Var Values"))
	virtual TArray<double> RetrieveVarValues() const override;

	// Retrieve a specific values by variable name
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Retreive Var Values Name"))
	...
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Retrieve Var Name String"))
	...
	UFUNCTION(Blueprintcallable, Category = "VIVEXRHeadsetSensorManager", meta = (Keywords = "Set Vehicle"))
